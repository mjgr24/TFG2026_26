...
def run_one_config(method, hyperparams, hospitals, hospital_loaders,
                   ...
                   class_counts=None, scenario="iid"):
    """
...
def main():
    ...
    fedprox_grid = [
        {"lr": 0.1, "local_epochs": 10, "mu": 0.001},
        {"lr": 0.01, "local_epochs": 5, "mu": 0.01},
        {"lr": 0.1, "local_epochs": 10, "mu": 0.01},
        {"lr": 0.01, "local_epochs": 5, "mu": 0.001},
        {"lr": 0.05, "local_epochs": 5, "mu": 0.001},
        {"lr": 0.05, "local_epochs": 10, "mu": 0.1},
        {"lr": 0.05, "local_epochs": 5, "mu": 0.01},
        {"lr": 0.1, "local_epochs": 1, "mu": 0.01},
        {"lr": 0.01, "local_epochs": 3, "mu": 0.01},
        {"lr": 0.05, "local_epochs": 3, "mu": 0.001},
    ]

    fedag_grid = [
        {"lr": 0.1, "local_epochs": 10, "lr_beta": 0.01},
        {"lr": 0.1, "local_epochs": 5, "lr_beta": 0.001},
        {"lr": 0.1, "local_epochs": 5, "lr_beta": 0.01},
        {"lr": 0.1, "local_epochs": 10, "lr_beta": 0.1},
        {"lr": 0.1, "local_epochs": 10, "lr_beta": 0.001},
        {"lr": 0.1, "local_epochs": 5, "lr_beta": 0.1},
        {"lr": 0.01, "local_epochs": 10, "lr_beta": 0.01},
        {"lr": 0.05, "local_epochs": 10, "lr_beta": 0.1},
        {"lr": 0.1, "local_epochs": 3, "lr_beta": 0.001},
        {"lr": 0.1, "local_epochs": 3, "lr_beta": 0.1},
    ]

    mh_cro_grid = [
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.0001, "gamma_reg": 0.005},
        {"lr": 0.1, "local_epochs": 5, "lambda_reg": 0.001, "gamma_reg": 0.05},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.00001, "gamma_reg": 0.05},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.01, "gamma_reg": 0.001},
        {"lr": 0.1, "local_epochs": 5, "lambda_reg": 0.0001, "gamma_reg": 0.05},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.00001, "gamma_reg": 0.01},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.001, "gamma_reg": 0.001},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.01, "gamma_reg": 0.05},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.0001, "gamma_reg": 0.001},
        {"lr": 0.1, "local_epochs": 10, "lambda_reg": 0.0001, "gamma_reg": 0.05},
    ]

    grids = {
        "fedavg": fedavg_grid,
        "fedprox": fedprox_grid,
        "fedewa": fedewa_grid,
        "fedag": fedag_grid,
        "mh_cro": mh_cro_grid,
    }
